...
db.users = new Nedb({ filename: './data/users.nedb', autoload: true });
 ...
 *
 */
db.challenges = new Nedb({ filename: './data/challenges.nedb', autoload: true })
 ...
 */
db.games = new Nedb({ filename: './data/games.nedb', autoload: true })
